            ...
            with chat_container:
                ...
                for message in st.session_state.messages:
                    if message.startswith("(private)"):
                        chat_html += f"<div style='color: purple; padding: 5px;'>{message}</div>"
                    elif message.startswith("(") and ")" in message:
                        chat_html += f"<div style='color: blue; padding: 5px;'>{message}</div>"
                    else:
                        chat_html += f"<div style='color: green; padding: 5px;'>{message}</div>"
